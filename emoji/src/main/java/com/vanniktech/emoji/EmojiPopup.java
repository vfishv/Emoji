  ...
  public void start() {
    if (SDK_INT >= LOLLIPOP) {
      if (onApplyWindowInsetsListener == null) {
        onApplyWindowInsetsListener = new View.OnApplyWindowInsetsListener() {
      ...
      context.getWindow().getDecorView().setOnApplyWindowInsetsListener(onApplyWindowInsetsListener);
    } else {
