...
@Config(manifest = Config.NONE) @RunWith(RobolectricTestRunner::class) class VariantEmojiManagerTest {
  ...
  @Before fun setUp() {
    ...
    emoji = Emoji(0x1f437, arrayOf("test"), R.drawable.emoji_recent, false)
    variant1 = Emoji(0x1f55b, arrayOf("test"), R.drawable.emoji_recent, false)
    variant2 = Emoji(0x1f55c, arrayOf("test"), R.drawable.emoji_recent, false)
    variant3 = Emoji(0x1f55d, arrayOf("test"), R.drawable.emoji_recent, false)
    base = Emoji(0x1f55a, arrayOf("test"), R.drawable.emoji_recent, false, variant1, variant2, variant3)
  }
